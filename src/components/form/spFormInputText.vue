<template lang="html">
	...
	<!-- START : spFormInput -->
		<div class="spFormInput">
			...
			<!-- START : Text Input -->
			<input v-bind:inputValue="inputValue" :value.prop="inputValue" v-on:input="setValue( $event )" class="spFormInputText" type="text" :disabled="details.locked">
			<!-- END   : Text Input -->
